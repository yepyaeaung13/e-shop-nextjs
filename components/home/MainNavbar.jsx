    ...
    <div className="text-white flex justify-between gap-3 items-center py-2">
      ...
      <div className="flex justify-center">
        <input
          ...
          name="search_box"
          id="searchBox"
          className="w-[30vw] py-0 px-2 border-none text-black focus:outline-none focus:border-none focus:ring-0 rounded-md"
          placeholder="Search Products"
        />
        <button className="bg-[#262b3d] py-1 px-2 rounded-md">
          <svg
      ...
      <div className="flex items-center gap-[2vw]">
        ...
        <nav className="relative md:hidden">
          ...
          >
            <Link className="hover:bg-[#262b3d] py-1 px-2 rounded-md" href="/">
              Home
            </Link>
            <Link
              className="hover:bg-[#262b3d] py-1 px-2 rounded-md"
